...
@Component({
  selector: 'app-tipo-de-deduccion',
  templateUrl: './tipo-de-deduccion.component.html',
  styleUrls: ['./tipo-de-deduccion.component.scss']
})
export class TipoDeDeduccionComponent implements OnInit {
  descripcion: string;
  codigo: number;
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(aTipoDeduc, {
      width: '500px',
      height: '350px',
...
@Component({
  selector: 'app-tipo-de-deduccion',
  templateUrl: './aTipoDeduc.html',
})
export class aTipoDeduc implements OnInit {
