...
@Component({
  selector: 'app-tipo-de-prestamo',
  templateUrl: './tipo-de-prestamo.component.html',
  styleUrls: ['./tipo-de-prestamo.component.scss']
})
export class TipoDePrestamoComponent implements OnInit {
  descripcion: string;
  codigo: number;
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(aTipoP, {
      width: '500px',
      height: '350px',
...
@Component({
  selector: 'app-tipo-de-prestamo',
  templateUrl: './aTipoP.html',
})
export class aTipoP implements OnInit {
