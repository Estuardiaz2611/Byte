...
@Component({
  selector: 'app-asesor-de-prestamos',
  templateUrl: './asesor-de-prestamos.component.html',
  styleUrls: ['./asesor-de-prestamos.component.scss']
})
export class AsesorDePrestamosComponent implements OnInit { 
  descripcion: string;
  codigo: number;
  ...
  openDialog(): void {
    const dialogRef = this.dialog.open(agregarAprestamos, {
      width: '500px',
      height: '350px',
...
@Component({
  selector: 'app-asesor-de-prestamos',
  templateUrl: './agregarAprestamos.html',
})
export class agregarAprestamos implements OnInit {
