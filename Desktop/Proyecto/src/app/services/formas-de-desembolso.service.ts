...
export class FormasDeDesembolsoService {
  ...
  getFormasDesembolso(idFormasDesembolso): Observable<any>{
    return this._http.get(this.url+'/formasdedesembolso/read?empresa=1&codigo='+idFormasDesembolso);
  }
  editFormasDesembolso(formasdedesembolso: FormasDeDesembolso): Observable<any> {
    var params = JSON.stringify(formasdedesembolso)
    return this._http.patch(this.url+'/formasdedesesmbolso/update', params, {headers: this.headers});
  }
  deleteFormasDesembolso(idFormasDesembolso):Observable<any> {
    return this._http.delete(this.url+'/formasdedesembolso/delete?empresa=1&codigo='+idFormasDesembolso);
  }
}